  ...
  return (
    <div className="bg-white">
      <header className="absolute flex justify-center  inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex items-center w-4/5 justify-around p-6 lg:px-8">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            ...
            <span className="text-black">Blog</span>
            <span className="text-blue-600">Hub, </span>
            View Blogs in Markdown
            </h1>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga possimus alias tenetur hic at autem eveniet tempore dignissimos exercitationem reiciendis.
            </p>
